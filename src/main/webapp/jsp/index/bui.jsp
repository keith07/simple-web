...
<head>
	...
	<title>bui</title>
	<link href="${ctx}/static/comp/assets/css/dpl-min.css" rel="stylesheet" type="text/css" />
	<link href="${ctx}/static/comp/assets/css/bui-min.css" rel="stylesheet" type="text/css" />
	<link href="${ctx}/static/comp/assets/css/main-min.css" rel="stylesheet" type="text/css" />
</head>
<body>
	<div class="header">
		<div class="dl-title">
			<a href="http://sc.chinaz.com" title="文档库地址" target="_blank">
				<!-- 仅仅为了提供文档的快速入口，项目中请删除链接 --> <span class="lp-title-port">BUI</span><span
				class="dl-title-text">前端框架</span>
			</a>
		</div>

		<div class="dl-log">
			欢迎您，<span class="dl-log-user">**.**@alibaba-inc.com</span>
			<a href="###" title="退出系统" class="dl-log-quit">[退出]</a>
			<a href="http://http://sc.chinaz.com/" title="文档库" class="dl-log-quit">文档库</a>
		</div>
	</div>
	<div class="content">
	...
	<script src="${ctx}/static/js/dev/jquery-2.1.1.js"></script>
	<script type="text/javascript" src="${ctx}/static/comp/assets/js/bui.js"></script>
	<script type="text/javascript" src="${ctx}/static/comp/assets/js/config.js"></script>
	...
	BUI.use('common/main',function(){
		var config = [{
				...
				menu:[{
					...
					{id:'goods-list',text:'商品',href:'${ctx}/goods/list'},
